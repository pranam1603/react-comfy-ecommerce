...
const products_reducer = (state, action) => {
  ...
  if (action.type === GET_PRODUCTS_SUCCESS) {
    ...
    return { ...state, product_loading: false, products: action.payload, featuredProducts }
  }
  ...
  if (action.type === GET_SINGLE_PRODUCT_SUCCESS) {
    return { ...state, single_product: action.payload, single_product_loading: false, single_product_error: false }
  }
